...
export const columns = [
  ...
  { name: "EMPLEADO", uid: "empleado", sortable: true },
...
export default function TableNa({ users, eliminar, edit }: props) {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "fecha":
        let text = new Date(user.fechaCita).toLocaleString();
        return text;
      case "cliente":
        return cellValue;
      case "role":
            ...
            <Dropdown>
              ...
              <DropdownMenu>
                {authUser?.role !== "Cliente" ? (
                  <DropdownItem
                  onPress={() => edit(user.id)}
                  key="edit">Edit</DropdownItem>
                ) : null}
                <DropdownItem
                  onPress={() => eliminar(user.id)}
                  key="delete"
                >
                  Delete
                </DropdownItem>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            {authUser?.role == "Cliente" && <ModalDate />}
            {/*
  ...
  const ez = React.useMemo(
    () => ({
      base: "bg-gray-700/15  rounded-lg shadow-lg backdrop-blur-md p-4",
